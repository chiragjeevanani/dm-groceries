      ...
      <div
        className={cn(
          ...
          compact
            ...
            : neutralBg
              ...
              : "bg-[#F5FBF5] border border-[#1A4516]/20",
          className,
        )}
        ...
        <div className="relative">
          ...
          {(badge ||
            ...
            product.originalPrice > product.price) && (
              <div
                className={cn(
                  "absolute z-10 bg-[#1A4516] text-white font-[900] rounded-md shadow-sm uppercase tracking-wider flex items-center justify-center",
                  compact
        ...
        <div
          ...
          <div className="flex items-center gap-1 mb-0.5 sm:gap-1.5 sm:mb-1">
            <div
              className={cn(
                "border-2 border-[#1A4516] rounded-full flex items-center justify-center",
                compact ? "h-2.5 w-2.5" : "h-2.5 w-2.5 sm:h-3.5 sm:w-3.5",
              )}>
              <div
                className={cn(
                  "bg-[#1A4516] rounded-full",
            ...
            <div
              className={cn(
                "bg-[#F5FBF5] text-[#1A4516] font-bold rounded px-1.5 py-0 tracking-wide",
